...
namespace TiltBrush
{
    ...
    /// 脚本排序：              
    /// -不需要追求任何东西              
    /// -必须在所有使用应用程序配置（即，所有脚本）                            
    /// 用于存储全局配置数据和常量。              
    /// 有关每个平台的数据，请参阅平台配置.cs              
    /// 尽管是公开的，所有这些数据都应该被认为是只读的
    public class Config : MonoBehaviour
    {
        ...
        //sdk模式指示我们使用哪个sdk（OVR、SteamVR等）来驱动显示。
    ...
    get { return Application.platform == RuntimePlatform.Android
        ...
        // Delete Batch's GeometryPool after about a second.//大约一秒钟后删除批处理的几何体池。 
