...
namespace TiltBrush
{
    ...
    { (int)KeyboardShortcut.InstantUpload, new KeyCode[] { KeyCode.U } },
        ...
        public bool GetCommand(SketchCommands rCommand)
        {
            ...
            // hardware.
            //在这里，您可以将给定的命令限制在特定的范围内，例如，只允许在魔杖上使用它 
            //或笔刷，但控制器信息负责如何将该命令映射到
            //硬件
        ...
        private bool HasSwapGestureCompleted()
        {
            ...
            {
                // Controllers should only swap when there is no active input.//控制器只应在没有活动输入时交换。
        ...
        /// 色调控制器和头盔显示器
        /// </summary>
        /// <param name="rTintColor"></param>
        /// <param name="fBaseIntensity"></param>
        /// <param name="fGlowIntensity"></param>
